"""
Django settings for red_base_40432 project.
...
ROOT_URLCONF = 'red_base_40432.urls'
...
WSGI_APPLICATION = 'red_base_40432.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_base_40432 API",
    "DESCRIPTION": "API documentation for red_base_40432 App",
    "VERSION": "v1",
}
